...
extern void vulture_put_tile_shaded(int x, int y, int tile_id, int shadelevel);
extern int vulture_load_gametiles(void);
extern vulture_tile * vulture_load_tile(int tile_id);
extern void vulture_unload_gametiles(void);
extern vulture_tile * vulture_get_tile_shaded(int tile_id, int shadelevel);
extern void vulture_tilecache_discard(void);
extern void vulture_tilecache_age(void);
extern void vulture_put_tilehighlight(int x, int y, int tile_id);
extern int vulture_monster_to_tile(int mon_id, int x, int y);
extern int vulture_object_to_tile(int mon_id, int x, int y, struct obj *in_obj);

extern int glassgems[CLR_MAX];

#define vulture_put_tile(x, y, tile_id) vulture_put_tile_shaded(x, y, tile_id, 0)
#define vulture_get_tile(tile_id) vulture_get_tile_shaded(tile_id, 0)
...
extern int vulture_typecount[NUM_TILETYPES];
...
#define EDGETILECOUNT  vulture_typecount[TT_EDGE]

#define FLOTILEOFFSET  (EDGETILEOFFSET + EDGETILECOUNT)
#define FLOTILECOUNT  vulture_typecount[TT_FLOOR]

#define WALTILEOFFSET  (FLOTILEOFFSET + FLOTILECOUNT)
#define WALTILECOUNT  vulture_typecount[TT_WALL]
